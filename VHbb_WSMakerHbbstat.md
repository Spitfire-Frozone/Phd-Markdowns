...
~~~
vim output/140ifb-0L-ade-Wbbfixed/tables/prefit/Yields_Prefit.tex
~~~
Then if you are happy then 
~~~
python WSMakerCore/scripts/comparePulls.py -w 140ifb-0L-ade 140ifb-0L-ade-WZmerge 140ifb-0L-ade-Wbbfixed -n -a 5 -l Zbb Vbb Wfixed
mv output/pullComparisons output/pullComparisons_Zbb_vs_Vbb_vs_Wfixed
~~~
