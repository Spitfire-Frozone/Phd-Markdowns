...
~~~
Before continuing it is important to check that your results are consistent with other peoples. Here '0LepFit29112019/0LMVAfit/' is a 0L standalone fit generated by someone else. Here I run a pull comparison and the pulls should be an exact match.
~~~
source setup.sh
python WSMakerCore/scripts/comparePulls.py -w 140ifb-0L-ade-STXS-baseline-MVA 0LepFit29112019/0LMVAfit/ -n -a 5 -l Dwayne Luca
mv output/pullComparisons output/DwaynevsLuca0LFit
~~~
### Asimov 0L Fit
~~~
vim scripts/launch_default_jobs.py 
